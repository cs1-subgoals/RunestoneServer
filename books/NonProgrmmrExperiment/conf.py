...
from runestone import runestone_static_dirs, runestone_extensions, script_files, css_files, setup
...
html_title = 'Java Subgoals'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Java Subgoals'
